...
export default function Candidat({ blogPosts, preview }: Props) {
      ...
      {router.isFallback ? (
        ...
        <>
          {/* <NextSeo
            ...
            canonical={`https://watchpr.ro/blog`}
            openGraph={{
              url: `https://watchpr.ro/blog`,
              title: `Noutăți - Watch PR`,
              description: `WATCH PR – Watchdog – Advocacy – Transparență – Corectitudine – Harta Politicii Românești`,
              images: blogPosts?.map((blogPost) => blogPost.image),
            }}
          /> */}
